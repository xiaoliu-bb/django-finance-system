    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('FINANCE', 'Finance Staff'), ('MANAGER', 'Manager'), ('AUDITOR', 'Auditor')], default='FINANCE', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('ADMIN', 'Administrator'), ('FINANCE', 'Finance Staff'), ('MANAGER', 'Manager'), ('AUDITOR', 'Auditor')], max_length=50, unique=True)),
